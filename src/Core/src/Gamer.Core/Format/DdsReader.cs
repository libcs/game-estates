...
namespace Gamer.Core.Format
{
    ...
    public struct DDSHeader //: DDS_HEADER
    {
        ...
        public void Write(GenericWriter w)
        {
            w.Write(dwSize);
    ...
    public static class DdsReader
    {
        ...
        /// </summary>
        public static Texture2DInfo LoadDDSTexture(string filePath, bool flipVertically = false) => LoadDDSTexture(File.Open(filePath, FileMode.Open, FileAccess.Read), flipVertically);
