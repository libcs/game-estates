...
namespace Asset.Format
{
    ...
    public struct Ptr<T>
    {
        ...
        public void Deserialize(GenericReader r) => Value = r.ReadInt32();
    }
    ...
    {
        public static Ptr<T> ReadPtr<T>(GenericReader r)
        {
            var ptr = new Ptr<T>();
            ptr.Deserialize(r);
            return ptr;
        ...
        public static Ref<T> ReadRef<T>(GenericReader r)
        {
        ...
        public static Ref<T>[] ReadLengthPrefixedRefs32<T>(GenericReader r)
        {
        ...
        public static ushort ReadFlags(GenericReader r) => r.ReadUInt16();

        public static T Read<T>(GenericReader r)
        {
            if (typeof(T) == typeof(float)) { return (T)(object)r.ReadSingle(); }
            else if (typeof(T) == typeof(byte)) { return (T)(object)r.ReadByte(); }
            else if (typeof(T) == typeof(string)) { return (T)(object)r.ReadLength32PrefixedASCIIString(); }
        ...
        public static NiObject ReadNiObject(GenericReader r)
        {
            var nodeTypeBytes = r.ReadLength32PrefixedBytes();
            if ("NiNode".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiNode(); node.Deserialize(r); return node; }
            else if ("NiTriShape".EqualsASCIIBytes(nodeTypeBytes)) { var triShape = new NiTriShape(); triShape.Deserialize(r); return triShape; }
            else if ("NiTexturingProperty".EqualsASCIIBytes(nodeTypeBytes)) { var prop = new NiTexturingProperty(); prop.Deserialize(r); return prop; }
            else if ("NiSourceTexture".EqualsASCIIBytes(nodeTypeBytes)) { var srcTexture = new NiSourceTexture(); srcTexture.Deserialize(r); return srcTexture; }
            else if ("NiMaterialProperty".EqualsASCIIBytes(nodeTypeBytes)) { var prop = new NiMaterialProperty(); prop.Deserialize(r); return prop; }
            else if ("NiMaterialColorController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiMaterialColorController(); controller.Deserialize(r); return controller; }
            else if ("NiTriShapeData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiTriShapeData(); data.Deserialize(r); return data; }
            else if ("RootCollisionNode".EqualsASCIIBytes(nodeTypeBytes)) { var node = new RootCollisionNode(); node.Deserialize(r); return node; }
            else if ("NiStringExtraData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiStringExtraData(); data.Deserialize(r); return data; }
            else if ("NiSkinInstance".EqualsASCIIBytes(nodeTypeBytes)) { var instance = new NiSkinInstance(); instance.Deserialize(r); return instance; }
            else if ("NiSkinData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiSkinData(); data.Deserialize(r); return data; }
            else if ("NiAlphaProperty".EqualsASCIIBytes(nodeTypeBytes)) { var prop = new NiAlphaProperty(); prop.Deserialize(r); return prop; }
            else if ("NiZBufferProperty".EqualsASCIIBytes(nodeTypeBytes)) { var prop = new NiZBufferProperty(); prop.Deserialize(r); return prop; }
            else if ("NiVertexColorProperty".EqualsASCIIBytes(nodeTypeBytes)) { var prop = new NiVertexColorProperty(); prop.Deserialize(r); return prop; }
            else if ("NiBSAnimationNode".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiBSAnimationNode(); node.Deserialize(r); return node; }
            else if ("NiBSParticleNode".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiBSParticleNode(); node.Deserialize(r); return node; }
            else if ("NiParticles".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiParticles(); node.Deserialize(r); return node; }
            else if ("NiParticlesData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiParticlesData(); data.Deserialize(r); return data; }
            else if ("NiRotatingParticles".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiRotatingParticles(); node.Deserialize(r); return node; }
            else if ("NiRotatingParticlesData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiRotatingParticlesData(); data.Deserialize(r); return data; }
            else if ("NiAutoNormalParticles".EqualsASCIIBytes(nodeTypeBytes)) { var node = new NiAutoNormalParticles(); node.Deserialize(r); return node; }
            else if ("NiAutoNormalParticlesData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiAutoNormalParticlesData(); data.Deserialize(r); return data; }
            else if ("NiUVController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiUVController(); controller.Deserialize(r); return controller; }
            else if ("NiUVData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiUVData(); data.Deserialize(r); return data; }
            else if ("NiTextureEffect".EqualsASCIIBytes(nodeTypeBytes)) { var effect = new NiTextureEffect(); effect.Deserialize(r); return effect; }
            else if ("NiTextKeyExtraData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiTextKeyExtraData(); data.Deserialize(r); return data; }
            else if ("NiVertWeightsExtraData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiVertWeightsExtraData(); data.Deserialize(r); return data; }
            else if ("NiParticleSystemController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiParticleSystemController(); controller.Deserialize(r); return controller; }
            else if ("NiBSPArrayController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiBSPArrayController(); controller.Deserialize(r); return controller; }
            else if ("NiGravity".EqualsASCIIBytes(nodeTypeBytes)) { var obj = new NiGravity(); obj.Deserialize(r); return obj; }
            else if ("NiParticleBomb".EqualsASCIIBytes(nodeTypeBytes)) { var modifier = new NiParticleBomb(); modifier.Deserialize(r); return modifier; }
            else if ("NiParticleColorModifier".EqualsASCIIBytes(nodeTypeBytes)) { var modifier = new NiParticleColorModifier(); modifier.Deserialize(r); return modifier; }
            else if ("NiParticleGrowFade".EqualsASCIIBytes(nodeTypeBytes)) { var modifier = new NiParticleGrowFade(); modifier.Deserialize(r); return modifier; }
            else if ("NiParticleMeshModifier".EqualsASCIIBytes(nodeTypeBytes)) { var modifier = new NiParticleMeshModifier(); modifier.Deserialize(r); return modifier; }
            else if ("NiParticleRotation".EqualsASCIIBytes(nodeTypeBytes)) { var modifier = new NiParticleRotation(); modifier.Deserialize(r); return modifier; }
            else if ("NiKeyframeController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiKeyframeController(); controller.Deserialize(r); return controller; }
            else if ("NiKeyframeData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiKeyframeData(); data.Deserialize(r); return data; }
            else if ("NiColorData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiColorData(); data.Deserialize(r); return data; }
            else if ("NiGeomMorpherController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiGeomMorpherController(); controller.Deserialize(r); return controller; }
            else if ("NiMorphData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiMorphData(); data.Deserialize(r); return data; }
            else if ("AvoidNode".EqualsASCIIBytes(nodeTypeBytes)) { var node = new AvoidNode(); node.Deserialize(r); return node; }
            else if ("NiVisController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiVisController(); controller.Deserialize(r); return controller; }
            else if ("NiVisData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiVisData(); data.Deserialize(r); return data; }
            else if ("NiAlphaController".EqualsASCIIBytes(nodeTypeBytes)) { var controller = new NiAlphaController(); controller.Deserialize(r); return controller; }
            else if ("NiFloatData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiFloatData(); data.Deserialize(r); return data; }
            else if ("NiPosData".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiPosData(); data.Deserialize(r); return data; }
            else if ("NiBillboardNode".EqualsASCIIBytes(nodeTypeBytes)) { var data = new NiBillboardNode(); data.Deserialize(r); return data; }
            else if ("NiShadeProperty".EqualsASCIIBytes(nodeTypeBytes)) { var property = new NiShadeProperty(); property.Deserialize(r); return property; }
            else { Utils.Log("Tried to read an unsupported NiObject type (" + System.Text.Encoding.ASCII.GetString(nodeTypeBytes) + ")."); return null; }
        }

        public static Matrix4x4 Read3x3RotationMatrix(GenericReader r) => r.ReadRowMajorMatrix3x3();
    }
    ...
    public class Key<T>
    {
        ...
        public void Deserialize(GenericReader r, KeyType keyType)
        {
            time = r.ReadSingle();
    ...
    public class Morph
    {
        ...
        public void Deserialize(GenericReader r, uint numVertices)
        {
            numKeys = r.ReadUInt32();
            interpolation = (KeyType)r.ReadUInt32();
    ...
    public abstract class NiObjectNET : NiObject
    {
        ...
        {
            base.Deserialize(r);
            Name = r.ReadLength32PrefixedASCIIString();
        ...
        public override void Deserialize(GenericReader r)
        {
            ...
            if (HasRotations)
            {
                ...
                for (var i = 0; i < Rotations.Length; i++)
                    Rotations[i] = r.ReadQuaternionWFirst();
            }
        }
    }
    ...
    public class NiSourceTexture : NiTexture
    {
        ...
        public override void Deserialize(GenericReader r)
        {
            ...
            FileName = r.ReadLength32PrefixedASCIIString();
