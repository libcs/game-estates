...
namespace Gamer.Base.Core
{
    public static class ServiceSet
    {
        ...
        public static T Add<T>(T service)
        {
            ...
            {
                Print($"Attempted to register service of type {type} twice.");
        ...
        public static void Remove<T>()
        {
            ...
            if (_services.ContainsKey(type))
                _services.Remove(type);
            else Print($"Attempted to unregister service of type {type}, but no service of this type (or type and equality) is registered.");
        }
        ...
        public static T Get<T>(bool failIfNotRegistered = true)
        {
            ...
            if (failIfNotRegistered)
                Print($"Attempted to get service service of type {type}, but no service of this type is registered.");
            return default(T);
        }
    }
}
