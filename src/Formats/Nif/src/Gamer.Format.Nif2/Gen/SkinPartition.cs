...
namespace Niflib
{
	...
	public class SkinPartition
	{
		...
		/*!
		 * Number of weight coefficients per vertex. The Gamebryo engine seems to work well only if this number is equal to 4, even if there are less than 4 influences per
		 * vertex.
		 */
