...
namespace Niflib
{
	...
	public class TexDesc
	{
		...
		internal short ps2L;
		/*!
		 * K is used as an offset into the mipmap levels and can range from -2047 to 2047. Positive values push the mipmap towards being blurry and negative values make
		 * the mipmap sharper.
		 */
		internal short ps2K;
		/*! Unknown, 0 or 0x0101? */
