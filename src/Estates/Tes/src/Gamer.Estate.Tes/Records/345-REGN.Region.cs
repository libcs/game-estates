...
namespace Gamer.Estate.Tes.Records
{
    public class REGNRecord : Record, IHaveEDID
    {
        ...
        public struct RDWTField
        {
            ...
            public static byte SizeOf(GameFormat format) => format == GameFormat.TES4 ? (byte)8 : (byte)12;
            public FormId<WTHRRecord> Weather;
            public uint Chance;
            public FormId<GLOBRecord> Global;

            public RDWTField(BinaryFileReader r, int dataSize, GameFormat format)
            {
                Weather = new FormId<WTHRRecord>(r.ReadUInt32());
                Chance = r.ReadUInt32();
                Global = format == GameFormat.TES5 ? new FormId<GLOBRecord>(r.ReadUInt32()) : new FormId<GLOBRecord>();
            }
        }
        ...
        public class RPLIField
        {
            ...
            public RPLIField(BinaryFileReader r, int dataSize) => EdgeFalloff = r.ReadUInt32();
