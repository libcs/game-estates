...
namespace Game.Estate.Ultima.Format
{
    ...
    {
        public static Vector3 SifVectorToUnityVector(Vector3 vector) { Utils.Swap(ref vector.y, ref vector.z); return vector; }

        public static Vector3 SifPointToUnityPoint(Vector3 point) => SifVectorToUnityVector(point); // / ConvertUtils.MeterInUnits;

        public static Matrix4x4 SifRotationMatrixToUnityRotationMatrix(Matrix4x4 rotationMatrix) => new Matrix4x4
        {
        ...
        public static Quaternion SifRotationMatrixToUnityQuaternion(Matrix4x4 rotationMatrix) => ConvertUtils.RotationMatrixToQuaternion(SifRotationMatrixToUnityRotationMatrix(rotationMatrix));
