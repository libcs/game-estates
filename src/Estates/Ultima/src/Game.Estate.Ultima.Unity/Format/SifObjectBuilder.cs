...
namespace Game.Estate.Ultima.Format
{
    public class SifObjectBuilder
    {
        ...
        GameObject InstantiateRootSiObject(SiObject obj)
        {
        ...
        void ProcessExtraData(SiObject obj, out bool shouldAddMissingColliders, out bool isMarker)
        {
        ...
        GameObject InstantiateSiObject(SiObject obj)
        {
        ...
        GameObject InstantiateSiNode(SiNode node)
        {
        ...
        GameObject InstantiateSiTriShape(SiTriShape triShape, bool visual, bool collidable)
        {
            Assert(visual || collidable);
        ...
        Mesh SiTriShapeDataToMesh(SiTriShapeData data) => null;
        ...
        void AddColliderFromSiObject(SiObject siObject, GameObject gameObject)
        {
            ...
            else Log($"Unsupported collider SiObject: {siObject.GetType().Name}");
        }

        bool IsMarkerFileName(string name) => false;
    }
}