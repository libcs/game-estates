...
namespace Gamer.Estate.Ultima
{
    ...
    {
        public static UltimaGame ToUltimaGame(this Uri uri, Func<object> func, out ProxySink proxySink, out string[] filePaths) => ProxySink.ToGame<UltimaGame>(uri, func, out proxySink, out filePaths, "Ultima", (path, game) => new string[0]);
