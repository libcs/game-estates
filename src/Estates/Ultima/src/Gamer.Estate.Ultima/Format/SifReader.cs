...
namespace Gamer.Estate.Ultima.Format
{
    ...
    public class SiFile
    {
        ...
        public SiFile(ResFile asset, string filePath)
        {
            _asset = asset;
        ...
        void LndBlocks(string filePath, short itemId)
        {
        ...
        void StaBlocks(string filePath, short itemId)
        {
        ...
        void GmpBlocks(string filePath, short itemId)
        {
