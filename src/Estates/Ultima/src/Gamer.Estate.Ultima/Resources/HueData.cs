...
namespace Gamer.Estate.Ultima.Resources
{
    public class HueData
    {
        ...
        static void graphicsDevice_DeviceReset(object sender, EventArgs e) => GetHueData();
        ...
        public static Texture2DInfo CreateHueSwatch(int width, int height, int[] hues)
        {
            ...
            return new Texture2DInfo(width, height, TextureFormat.Alpha8, false, pixels);
        }
        ...
        public static Texture2DInfo HueTexture0 { get; private set; }

        public static Texture2DInfo HueTexture1 { get; private set; }

        public static int GetWebSafeHue(Color32 inColor) => GetWebSafeHue(inColor.r, inColor.g, inColor.b);
