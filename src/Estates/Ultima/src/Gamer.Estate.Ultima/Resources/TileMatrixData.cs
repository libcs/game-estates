...
namespace Gamer.Estate.Ultima.Resources
{
    public class TileMatrixData
    {
        ...
        public byte[] GetLandChunk(uint chunkX, uint chunkY) => _mapDataStream == null ? _invalidLandChunk : ReadLandChunk(chunkX, chunkY);
        ...
        unsafe byte[] ReadStaticChunk(uint chunkX, uint chunkY, out int length)
        {
            ...
            try
            {
                ...
                _staticDataStream.ReadBuffer(_staticTileLoadingBuffer, length);
                return _staticTileLoadingBuffer;
            }
        ...
        unsafe byte[] ReadLandChunk(uint chunkX, uint chunkY)
        {
            ...
            _mapDataStream.ReadBuffer(_bufferedLandChunks[index], SizeOfLandChunkData);
