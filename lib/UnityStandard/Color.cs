namespace UnityEngine
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        {
            object[] args = new object[] { this.r.ToString(format, CultureInfo.InvariantCulture.NumberFormat), this.g.ToString(format, CultureInfo.InvariantCulture.NumberFormat), this.b.ToString(format, CultureInfo.InvariantCulture.NumberFormat), this.a.ToString(format, CultureInfo.InvariantCulture.NumberFormat) };
